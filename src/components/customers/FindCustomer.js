...
const FindCustomer = () => {
  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {seraching && currentCustomers?.length === 0 && (
            <Flex alignItems='center'>
              <Typography variant='body3'>No customers found. You can  <Button variant='secondary' size='small' onClick={addNewCustomer} data-testid='button-nav-to-add'>Create</Button> the customer here</Typography>
            </Flex>
      ...
      {seraching && currentCustomers?.length === 0 && (
        <Alert data-testid='message-no-customer'>No customers found</Alert>
      )}
    </>
  )
}
